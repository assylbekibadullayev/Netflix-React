...
function  Login(){
    ...
    return(
        <div className="relaltive flex h-screen w-screen  flex-col bg-black md:items-center md:justify-center md:bg-transparent">
            <Head>
                <title>Netflix</title>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="relative mt-24 space-y-8 rounded bg-black/75 py-10 px-6 md:mt-0 md:max-w-md md:px-14">
                ...
                <div className="text-[gray]">
                    New to Netflix?{' '}
                    <button className="text-white hover:uderline"
                            onClick={()=>
                            setLogin(false)}>
                        Sign up now
                    </button>
